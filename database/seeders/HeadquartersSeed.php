...
class HeadquartersSeed extends Seeder
{
    ...
    public function run()
    {
        $headquarters = [
            ...
            ["id" => 2, "name" => "Escuela Indígena Itaka", "dane_code" => "244035003432", "address" => "Km 41 Via Riohacha-1", "municipality" => "Albania", "department" => "La Guajira", "email" => "mail@mail.com", "phone" => "3133782458", "establishment_id" => 2, "created_at" => "2022-06-07T00:48:14.000000Z", "updated_at" => "2022-06-07T00:48:14.000000Z"],
            ...
            ["id" => 24, "name" => "Sede El pasito", "dane_code" => "3004215140", "address" => "Comunidad El Pasito", "municipality" => "Riohacha-1", "department" => "La Guajira", "email" => "mail@mail.com", "phone" => "3004215140", "establishment_id" => 19, "created_at" => "2022-06-07T03:01:43.000000Z", "updated_at" => "2022-06-07T03:01:43.000000Z"],
            ["id" => 25, "name" => "Sede Paraver", "dane_code" => "244001003514", "address" => "Comunidad Paraver", "municipality" => "Riohacha-1", "department" => "La Guajira", "email" => "mail@mail.com", "phone" => "3106120762", "establishment_id" => 20, "created_at" => "2022-06-07T03:02:50.000000Z", "updated_at" => "2022-06-07T03:02:50.000000Z"],
            ["id" => 26, "name" => "Sede Kousachon", "dane_code" => "24400001005011", "address" => "Comunidad Kousachon", "municipality" => "Riohacha-1", "department" => "La Guajira", "email" => "mail@mail.com", "phone" => "3008052296", "establishment_id" => 18, "created_at" => "2022-06-07T03:04:06.000000Z", "updated_at" => "2022-06-07T03:04:06.000000Z"],
            ["id" => 27, "name" => "Sede Mañature", "dane_code" => "244001004529", "address" => "Resguardo Mañature", "municipality" => "Riohacha-1", "department" => "La Guajira", "email" => "mail@mail.com", "phone" => "0000000000", "establishment_id" => 21, "created_at" => "2022-06-07T03:05:06.000000Z", "updated_at" => "2022-06-07T03:05:06.000000Z"]
        ];

...
class EstablishmentsSeeder extends Seeder
{
    ...
    public function run()
    {
        $establishments = [
            ...
            [18, "Centro etnoeducativo #17 (kousachon)", "0000", "Riohacha-1", "La Guajira",],
            [19, "Centro etnoeducativo #4", "0000", "Riohacha-1", "La Guajira",],
            [20, "Centro etnoeducativo #8 (paraver)", "0000", "Riohacha-1", "La Guajira",],
            [21, "Centro etnoeducativo #9 (mañature)", "0000", "Riohacha-1", "La Guajira"],
        ];

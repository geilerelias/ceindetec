<template>
    <app-layout>
        <bread-crumbs name="Plan de estudio" :items="items"></bread-crumbs>
    ...
    data() {
        return {
            ...
            headers: [
                ...
                {text: 'Año lectivo', value: 'year_id'},
    ...
    methods: {
        ...
        save: function (data) {
            ...
            if (!this.validate() && !this.valid) {
                ...
                this.$inertia.post(this.route('study-plans.store'), data, {
                    onSuccess: (response) => {
                        ...
                        this.$swal({
                            ...
                            if (result.isConfirmed) {
                                ...
                                this.$inertia.get(this.route('study-plans.index'));
                            }
                        });
                    },
                    onError: error => {
        ...
        update: function (data) {
            data._method = 'PUT';
            this.$inertia.post(this.route('study-plans.update', data.id), data, {
                onSuccess: page => {
                    this.$swal({
        ...
        deleteRow(item) {
            ...
            this.$swal({
                ...
                if (result.isConfirmed) {
                    this.$inertia.post(this.route('study-plans.destroy', item.id), item, {
                        onStart: (visit) => {

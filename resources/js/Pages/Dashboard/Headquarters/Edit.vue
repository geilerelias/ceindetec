    ...
    methods: {
        ...
        update() {
            ...
            if (!this.validate() && !this.valid) {
                ...
                this.headquarters._method = 'PUT';

                this.$inertia.post(this.route('headquarters.update', this.headquarters.id), this.headquarters, {

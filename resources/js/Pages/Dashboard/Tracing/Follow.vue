<template>
    <app-layout>
        <bread-crumbs name="Seguimientos de Obras" :items="items"></bread-crumbs>
        <v-container>
            <v-row class="ma-0">
                <v-col>
                                        ...
                                        <v-card>
                                            <v-list>
                                                <v-list-item>
                                                    ...
                                                    <v-list-item-content>
                                                        <v-list-item-title>Filtro de búsqueda</v-list-item-title>
                                                        <v-list-item-subtitle>Desactiva o activa las opciones de
                                                            búsquedas
